...
BRIANCANCER_TRAIN_DIR = str(globals().get("BRIANCANCER_TRAIN_DIR", "/path/to/your/Briancancer train data"))
BRIANCANCER_TEST_DIR = str(globals().get("BRIANCANCER_TEST_DIR", "/path/to/your/Briancancer test data"))
...
DINO_LOCAL_CKPT = globals().get(
    "DINO_LOCAL_CKPT",
    "/path/to/your/dinov3_vit7b16_pretrain_lvd1689m-a955f4ea.pth", "/path/to/your/Briancancer/train/train"
)
...
DATASET_TAG = str(globals().get("DATASET_TAG", "briancancer")).strip()
CACHE_DIR = str(globals().get("CACHE_DIR", f"/home/imagea/zhibo/features_cache_{DATASET_TAG}_dinov3FD_fusion_RGB"))
...
def main():
    ...
    from topoformer.data.split_builders import build_briancancer_train_test
    ...
    split = build_briancancer_train_test(
        train_dir=BRIANCANCER_TRAIN_DIR,
        test_dir=BRIANCANCER_TEST_DIR,
    )
    ...
    print("[info] DINO-FD Briancancer splits:")
    print("  train:", BRIANCANCER_TRAIN_DIR, "N=", int(fd_train_idx.size))
    print("  test :", BRIANCANCER_TEST_DIR, "N=", int(fd_test_idx.size))
